...
- A [MongoDB](https://www.mongodb.com) database (version 8.0). Deployed using docker-compose with official MongoDB 8.0 Docker images from [Docker Hub](https://hub.docker.com/_/mongo).
